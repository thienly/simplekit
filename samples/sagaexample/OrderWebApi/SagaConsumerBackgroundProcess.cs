...
namespace OrderWebApi
{
    ...
    public class SagaConsumerBackgroundProcess : IHostedService, IDisposable
    {
        private Timer _timer;
        private IServiceProvider _serviceProvider;
        private ILogger<TimerBackgroundProcess> _logger;

        public SagaConsumerBackgroundProcess(IServiceProvider serviceProvider, ILogger<TimerBackgroundProcess> logger)
        {
